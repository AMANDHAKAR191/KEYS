...
import com.example.keys.baseactivitys.ProfileActivity;
...
public class PassGenActivity extends AppCompatActivity {
    ...
    DatabaseReference myRef = firebaseDatabase.getReference("usedPassword");
    int initialvalue;
    String getnumber = "0";
...
//        bt_use.setVisibility(View.VISIBLE);
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PassGenActivity.this, HomeActivity.class));
                finish();
            }
        });
    ...
    public void pass_gen_bottom_nav() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.menu_setting:
                        startActivity(new Intent(PassGenActivity.this, SettingActivity.class));
                        overridePendingTransition(0, 0);
                        return true;
                    case R.id.menu_profile:
                        startActivity(new Intent(PassGenActivity.this, ProfileActivity.class));
                        overridePendingTransition(0, 0);
                        return true;
                }
                return false;
