...
//
//public class myAdaptorForChatMessages extends RecyclerView.Adapter<myAdaptorForChatMessages.myviewholder> {
...
//
//    public myAdaptorForChatMessages(ArrayList<AddNoteDataHelperClass> dataholder, Context context, Activity activity) {
...
//
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_messages_layout, parent, false);
