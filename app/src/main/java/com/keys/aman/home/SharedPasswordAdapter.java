...
public class SharedPasswordAdapter extends RecyclerView.Adapter<SharedPasswordAdapter.myViewHolder> implements Filterable {
    ...
    public SharedPasswordAdapter(ArrayList<PasswordHelperClass> tempDataHolder, Context context, Activity activity) {
