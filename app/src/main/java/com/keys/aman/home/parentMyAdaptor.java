...
//
//public class parentMyAdaptor extends RecyclerView.Adapter<parentMyAdaptor.myviewholder> implements Filterable {
//    ArrayList<AddPasswordDataHelperClass> dataholder;
//    private ArrayList<String> parentDataHolder;
//    private ArrayList<String> parentDataHolderFull;
...
//        parentDataHolderFull = new ArrayList<>(parentDataHolder);
//    }
//
//
//    @NonNull
...
//                filteredList.addAll(parentDataHolderFull);
//            }else {
//                String filterPattern = charSequence.toString().toLowerCase().trim();
//                for(String tempItem : parentDataHolderFull){
//                    if (tempItem.toLowerCase().contains(filterPattern)){
